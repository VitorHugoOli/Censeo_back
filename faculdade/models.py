...
class TopicoFaculdade(models.Model):
    idtopico_faculdade = models.IntegerField(db_column='idTopico_Faculdade', primary_key=True)  # Field name made lowercase.
...
class SugestaoFaculdade(models.Model):
    idsugestao_faculdade = models.IntegerField(db_column='idSugestao_Faculdade', primary_key=True)  # Field name made lowercase.
    ...
    topico_faculdade_idtopico_faculdade = models.ForeignKey(TopicoFaculdade, models.DO_NOTHING, db_column='Topico_Faculdade_idTopico_Faculdade')  # Field name made lowercase.
