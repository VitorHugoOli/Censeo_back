...
class Teorica(models.Model):
    idteorica = models.AutoField(db_column='idTeorica', primary_key=True)  # Field name made lowercase.
    aula_idaula = models.ForeignKey(Aula, models.DO_NOTHING, db_column='Aula_idAula')  # Field name made lowercase.
...
class TrabalhoPratico(models.Model):
    idtrabalho_pratico = models.AutoField(db_column='idTrabalho_Pratico',
...
class Excursao(models.Model):
    idexcursao = models.AutoField(db_column='idExcursao', primary_key=True)  # Field name made lowercase.
